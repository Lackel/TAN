...
def clustering_accuracy_score(y_true, y_pred, known_lab):
    ...
    return (round(2*old_acc*new_acc / (old_acc+new_acc)*100, 2), round(old_acc*100, 2), round(new_acc*100, 2))

def clustering_score(y_true, y_pred, known_lab):
    return {'H_score': clustering_accuracy_score(y_true, y_pred, known_lab)[0],
